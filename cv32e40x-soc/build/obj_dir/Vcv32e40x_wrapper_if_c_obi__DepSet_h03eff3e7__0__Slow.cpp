...
VL_ATTR_COLD void Vcv32e40x_wrapper_if_c_obi___ctor_var_reset(Vcv32e40x_wrapper_if_c_obi* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vcv32e40x_wrapper_if_c_obi___ctor_var_reset\n"); );
    Vcv32e40x_wrapper__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->s_req = VL_RAND_RESET_I(1);
    vlSelf->req_payload = VL_RAND_RESET_Q(37);
